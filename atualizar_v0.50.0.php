...
const TARGET_VERSION = '0.50.0';
const MIN_VERSION = '0.49.0';
...
try {
    ...
    installResource(
        'admin/_content_blocks_editor.php',
        'admin/_content_blocks_editor.php',
        'Editor compartilhado de blocos v0.50.0',
        true
    );
    ...
    out(
        '[OK] Novo bloco: FAQ / Acordeão.'
    );
    out(
        '[OK] Até 50 perguntas por bloco.'
    );
    out(
        '[OK] Perguntas podem ser reordenadas.'
    );
    out(
        '[OK] Primeira pergunta pode iniciar aberta.'
    );
    out(
        '[OK] Respostas são escapadas com segurança.'
    );
    out(
        '[OK] O bloco também pode ser salvo em Padrões de conteúdo.'
    );
    out(

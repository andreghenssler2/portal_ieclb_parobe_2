...
$labels=['noticia'=>'Notícia','pagina'=>'Página','evento'=>'Evento','galeria'=>'Galeria',,'documento'=>'Documento'];
...
?>
<section class="container py-5"><div class="search-page mx-auto"><h1 class="h2 mb-4">Busca</h1><form class="input-group input-group-lg mb-4" method="get" action="<?= e(url('busca')) ?>"><input class="form-control" type="search" name="q" value="<?= e($q) ?>" placeholder="Buscar notícias, páginas, eventos, documentos..." minlength="2" required><button class="btn btn-primary">Buscar</button></form>

...
out(
    'Correção do bloco de Vídeo do YouTube/Vimeo'
);
out(
    str_repeat('-', 80)
);
...
try {
    ...
    out(
        '[OK] YouTube watch?v= reconhecido.'
    );
    out(
        '[OK] youtu.be reconhecido.'
    );
    out(
        '[OK] YouTube Shorts reconhecido.'
    );
    out(
        '[OK] YouTube Live reconhecido.'
    );
    out(
        '[OK] YouTube Embed e youtube-nocookie reconhecidos.'
    );
    out(
        '[OK] Links do YouTube sem https:// são normalizados.'
    );
    out(
        '[OK] Tempo inicial t= / start= é preservado no player.'
    );
    out(
        '[OK] Vimeo normal/player continua compatível.'
    );
    out(
        'Faça Ctrl+F5 antes de abrir o editor.'
    );
